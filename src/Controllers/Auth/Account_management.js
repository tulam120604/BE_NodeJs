  ...
  try {
    ...
    await Notifications.create({
      ...
      notification_message:
        "Quản trị viên đã chấp nhận yêu cầu trở thành nhà phân phối trên Store88, bạn vui lòng đăng nhập lại để bắt đầu kinh doanh mặt hàng của mình.Chúc may mắn!",
      receiver_id: id_user,
